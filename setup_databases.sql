...
CREATE DATABASE IF NOT EXISTS ett_training;
CREATE DATABASE IF NOT EXISTS ett_employee;
CREATE DATABASE IF NOT EXISTS ett_attendance;

-- Use ett_training database for training program service
USE ett_training;
...
-- Use ett_employee database for employee service
USE ett_employee;
...
-- Use ett_attendance database for tracking service
USE ett_attendance;
